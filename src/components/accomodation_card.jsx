...
function AccomodationCard({logement_data, id}){
	return (
		<Link to={`/fiche-logement/${logement_data.id}`} key={`accomodation-item-${logement_data.id}-${id}`} className="accomodation-item-wrapper">
